...
# Secret folders
path1 = "$HOME/AllHackingTools/.logs/"
path2 = "$HOME/AllHackingTools/.settings/"
path3 = "$HOME/AllHackingTools/.temp/"
path4 = "$HOME/AllHackingTools/.check/"

# No secret folders
path5 = "$HOME/AllHackingTools/Files/"
path6 = "$HOME/AllHackingTools/src/"
path7 = "$HOME/AllHackingTools/Tool/"
path8 = "$HOME/AllHackingTools/Themes/"
path9 = "$HOME/AllHackingTools/Castom/"
