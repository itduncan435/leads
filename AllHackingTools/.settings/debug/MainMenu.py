...
if(op==1):
 ...
 os.system("bash src/Inf.sh")
 time.sleep(0.3)
 os.system("cd && cd AllHackingTools && python3 .settings/settingsMenu2.py")
elif(op==21):
 os.system("bash src/Inf.sh")
 time.sleep(0.3)
 ...
 os.system("cd && cd AllHackingTools && cd src && rm -rf AnimationLoad1.sh && rm -rf AnimationLoad2.sh && cd && cd AllHackingTools && cd .settings && cd debug && cp AnimationLoad1.sh $HOME/AllHackingTools/src && cp AnimationLoad2.sh $HOME/AllHackingTools/src") 
elif(op==46):
