...
if(op==1):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd .check && mv CheckServerYesAndNo.py $HOME/AllHackingTools/.temp/ && cd && cd AllHackingTools && cd .settings && mv CheckServerYesAndNo.py $HOME/AllHackingTools/.check/ && cd && cd AllHackingTools && cd .temp && mv CheckServerYesAndNo.py $HOME/AllHackingTools/.settings/ && cd && cd AllHackingTools && bash .settings/Applined.sh")
elif(op==2):
 os.system("clear")
