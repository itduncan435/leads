...
if(op==1):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd wlcreator && ./wlcreator 5 && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd GoblinWordGenerator && python3 goblin.py && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd SMWYG-Show-Me-What-You-Got && python3 SMWYG.py && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==4):
 time.sleep(0.2)
