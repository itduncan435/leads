...
if(op==1):
 ...
 time.sleep(2)
 os.system("cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Debinject && python3 debinject.py && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Infect && Infect && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==4):
 time.sleep(0.2)
