...
op=int(input("OthErTo01s: "))

if(op==1):
 os.system("clear")
 os.system("cd && cd AllHackingTools && bash Files/Proxy/Logo.sh && python3 Files/Proxy/menu.py && cd")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Intersect-2.5 && python3 Create.py")
elif(op==3):
 time.sleep(0.2)
 ...
 os.system("cd")
 os.system("cd AllHackingTools")
 os.system("python3 Files/Other.py")
