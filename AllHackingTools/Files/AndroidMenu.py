...
op=int(input("R6moteTRo1anR8t: "))

if(op==1):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd pyshell && ./Pyshell && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd WishFish && ./wishfish.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd lockphish && bash lockphish.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==4):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Files && bash HatCloud.sh && cd && cd AllHackingTools && python3 src/Timer2.py && python3 MainMenu.py")
elif(op==5):
 time.sleep(0.2)
