...
op=int(input("CamPh1sh: "))

if(op==1):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Cam-Hackers && python3 cam-hackers.py && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd grabcam && bash grabcam.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd CamHack && bash CamHack.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==4):
 time.sleep(0.2)
