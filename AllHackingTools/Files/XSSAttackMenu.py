...
op=int(input("XSSattACk: "))

if(op==1):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Files && bash XSScon.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Files && bash XanXSS.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd AllHackingTools && cd Files && bash XSStrike.sh && cd && cd AllHackingTools && python3 MainMenu.py")
elif(op==4):
 time.sleep(0.2)
