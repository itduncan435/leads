...
cd
cd 
cd && cd AllHackingTools && python3 src/TerminalBanner.py
cd
cd
cd AllHackingTools
cd Tool
chmod +x folder
chmod +x os
mv folder $HOME/AllHackingTools
mv os $HOME/AllHackingTools
cd
cd
cd AllHackingTools
cd Files
